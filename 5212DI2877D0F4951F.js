...
mqttClient.on('connect', () => {
    ...
    mqttClient.subscribe('5212DI2877D0F4951F', (error) => {
        if (error) {
...
mqttClient.on('message', (topic, message) => {
    try {
        ...
        console.log('Data Collected For Device', data.device_uid || data.DeviceUID, data);
        ...
        const insertValuesInEMS = [
            data.DeviceUID || data.device_uid || '5212DI2877D0F4951F',
            data.V_1n || data['1'],
            data.V_2n || data['2'],
            data.V_3n || data['3'],
            data.V_N || data['4'],
        ...
        if (data.DeviceUID || data.device_uid || '5212DI2877D0F4951F') {
