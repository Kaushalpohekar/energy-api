...
const derivedFieldMap = [
    {
        target: 'kwh',
        source: 'wh_total',
        transform: (val) => parseFloat(val) / 1000
    },
    {
        target: 'kw_1',
        source: 'w_a',
...
const dbFieldAliases = {
    ...
    kwh: ['kwh', 'kWh exp+imp', 'kWh_exp_L', 'kwh_exp_imp', 'kwh-exp-imp', 'KWH_EXP_IMP', 'kWhExpImp', 'total_kwh', 'Total_kWh', 'kWh_Total', 'kwh_total_energy', 'energy_kwh', 'Energy_kWh', 'kWhSum', 'kwhSum', 'kwh_total', 'kwh_all', 'ActiveEnergyTotal_kWh', 'TotalEnergy_kWh', 'wh_tota'],
    ...
    voltage_n: ['V_L-N Avg', 'V_L-N_Avg', 'V_L_N_Avg', 'V_Avg_N', 'V_LN_Avg', 'V_LNAVG', 'VLNAvg', 'voltage_ln_avg', 'V_LtoN_Avg', 'LineToNeutralVoltage', 'voltage_n', 'v_l_n_avg'],
    voltage_1n: ['V_A-N', 'V_A_N', 'VA-N', 'VA_N', 'Voltage_A_N', 'Voltage_A-N', 'PhaseA_Voltage_N', 'Voltage_AN', 'V_A_to_N', 'voltage_1n', 'v_a_n'],
    voltage_2n: ['V_B-N', 'V_B_N', 'VB-N', 'VB_N', 'Voltage_B_N', 'Voltage_B-N', 'PhaseB_Voltage_N', 'Voltage_BN', 'V_B_to_N', 'voltage_2n', 'v_b_n'],
    voltage_3n: ['V_C-N', 'V_C_N', 'VC-N', 'VC_N', 'Voltage_C_N', 'Voltage_C-N', 'PhaseC_Voltage_N', 'Voltage_CN', 'V_C_to_N', 'voltage_3n', 'v_c_n'],
    ...
    pf_1: ['PF_A', 'pf_a', 'PowerFactor_A', 'power_factor_a', 'Power_Factor_A', 'pf-a', 'PF-A', 'PhaseA_PF', 'pf1', 'pf_1', 'pf_a'],
    pf_2: ['PF_B', 'pf_b', 'PowerFactor_B', 'power_factor_b', 'Power_Factor_B', 'pf-b', 'PF-B', 'PhaseB_PF', 'pf2', 'pf_2', 'pf_b'],
    pf_3: ['PF_C', 'pf_c', 'PowerFactor_C', 'power_factor_c', 'Power_Factor_C', 'pf-c', 'PF-C', 'PhaseC_PF', 'pf3', 'pf_3', 'pf_c'],
    pf: ['PF_Avg', 'PF_avg', 'pf_avg', 'PFAVG', 'Average_PF', 'AvgPF', 'avg_pf', 'PowerFactor_Avg', 'Power_Factor_Total', 'pf_total', 'pf', 'pf_avg'],
    freq: ['F', 'f', 'Frequency', 'frequency', 'Freq', 'Freq_Hz', 'frequency_hz', 'Hz', 'hz', 'freq'],
    voltage_12: ['V_A-B', 'V_A_B', 'VA-B', 'VA_B', 'Voltage_AB', 'Voltage_A_B', 'LineVoltage_AB', 'voltage_ab', 'voltage_12', 'v_a_b'],
    voltage_23: ['V_B-C', 'V_B_C', 'VB-C', 'VB_C', 'Voltage_BC', 'Voltage_B_C', 'LineVoltage_BC', 'voltage_bc', 'voltage_23', 'v_b_c'],
    voltage_31: ['V_C-A', 'V_C_A', 'VC-A', 'VC_A', 'Voltage_CA', 'Voltage_C_A', 'LineVoltage_CA', 'voltage_ca', 'voltage_31', 'v_c_a'],
    ...
    kw: ['kw_Avg', 'kW_Avg', 'KW_Avg', 'KWAVG', 'Avg_kW', 'Average_kW', 'kw_avg', 'kw-total', 'kwTotal', 'Total_kW', 'kw', 'ActivePowerTotal', 'w_avg'],
    kvar_1: ['kVAr_A', 'KVAR_A', 'kvar_A', 'kVAR-A', 'kVAR_A_Phase', 'ReactivePower_A', 'kvarA', 'kvar_1', 'kvar_a'],
    kvar_2: ['kVAr_B', 'KVAR_B', 'kvar_B', 'kVAR-B', 'kVAR_B_Phase', 'ReactivePower_B', 'kvarB', 'kvar_2', 'kvar_b'],
    kvar_3: ['kVAr_C', 'KVAR_C', 'kvar_C', 'kVAR-C', 'kVAR_C_Phase', 'ReactivePower_C', 'kvarC', 'kvar_3', 'kvar_c'],
    kvar: ['kVAr_Avg', 'KVAr_Avg', 'KVAR_Avg', 'kvar_avg', 'kvar_Avg', 'kVARAVG', 'Avg_kVAR', 'kvarTotal', 'ReactivePowerTotal', 'kvar', 'kvar_avg'],
    kva_1: ['kVA_A', 'KVA_A', 'kva_A', 'KVA-A', 'ApparentPower_A', 'Apparent_Power_A', 'kvaA', 'KvaA', 'kva_1', 'kva_a'],
    kva_2: ['kVA_B', 'KVA_B', 'kva_B', 'KVA-B', 'ApparentPower_B', 'Apparent_Power_B', 'kvaB', 'KvaB', 'kva_2', 'kva_b'],
    kva_3: ['kVA_C', 'KVA_C', 'kva_C', 'KVA-C', 'ApparentPower_C', 'Apparent_Power_C', 'kvaC', 'KvaC', 'kva_3', 'kva_c'],
    kva: ['kVA_Avg', 'KVA_Avg', 'KVA avg', 'kva avg', 'kva_avg', 'Kva_Avg', 'KVA-Avg', 'kva-avg', 'Avg_KVA', 'Average_KVA', 'average_kva', 'AVG_KVA', 'AVG kva', 'avg_kva', 'kvaTotal', 'ApparentPowerTotal', 'kva', 'kva_avg'],
...
mqttClient.on('message', (topic, message) => {
    try {
        ...
        const isNested = Object.values(raw).some(val => typeof val === 'object' && val?.DeviceUID);

        if (isNested) {
            for (const key in raw) {
                if (key.toLowerCase().startsWith('meter_') && typeof raw[key] === 'object') {
                    meters.push(raw[key]);
                }
            }
        } else {
